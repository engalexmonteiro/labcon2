(function () {
  ...
  function selectedRole()  { return document.querySelector("#register-role").value; }
  ...
  function updateStudentFields() {
    const isStudent  = selectedRole()  === "aluno";
    const isPostgrad = selectedLevel() === "pos-graduacao";
    const advisor    = document.querySelector("#register-advisor");

    document.querySelectorAll(".register-student-only")
      .forEach((el) => el.classList.toggle("hidden", !isStudent));
    ...
    if (advisor) {
      advisor.required = isStudent;
      if (!isStudent) advisor.value = "";
    }
  }
  ...
  document.querySelector("#register-role").addEventListener("change", updateStudentFields);
  ...
  document.querySelector("#register-form").addEventListener("submit", async (event) => {
    ...
    if (role === "aluno") {
      ...
      body.advisorName = advisor.name;
      body.researchProject = document.querySelector("#register-research-project").value.trim();
